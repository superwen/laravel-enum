...
namespace Superwen\LaravelEnum\Console\Commands;

use Illuminate\Console\GeneratorCommand;
use Illuminate\Support\Str;
use Rexlabs\Enum\Exceptions\InvalidKeyException;
use Superwen\LaravelEnum\Keys;
use Superwen\LaravelEnum\Parser;
use Superwen\LaravelEnum\StubAssembler;
...
class EnumMakeCommand extends GeneratorCommand
{
     ...
     *
     * @return \Superwen\LaravelEnum\Keys|null
     */
